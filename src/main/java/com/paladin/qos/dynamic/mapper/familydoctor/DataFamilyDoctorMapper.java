...
public interface DataFamilyDoctorMapper {
    ...
    public List<String> registerOPDtotal(@Param("startTime") Date startTime, @Param("endTime") Date endTime, @Param("unitId") String unitId, @Param("idCard") List<String> idCard);
    public long hospitalOPDTotal(@Param("startTime") Date startTime, @Param("endTime") Date endTime, @Param("unitId") String unitId, @Param("idCard") List<String> idCard);
