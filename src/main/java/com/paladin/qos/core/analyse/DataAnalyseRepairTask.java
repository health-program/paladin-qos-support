...
public class DataAnalyseRepairTask extends DataTask {

	private static Logger logger = LoggerFactory.getLogger(DataAnalyseRepairTask.class);
	...
	public DataAnalyseRepairTask(DataProcessor processor, AnalysisService analysisService) {
